"""UPP provider scaffold for the LMS integration hub."""
...
class UppProvider(LmsProvider):
    ...
    def __init__(self, api_url: str | None = None, api_token: str | None = None) -> None:
        ...
        self.api_token = (api_token if api_token is not None else os.getenv("UPP_API_TOKEN", "")).strip()

    def is_configured(self) -> bool:
        return bool(self.api_url and self.api_token)

    def list_courses(self) -> list[ExternalCourse]:
        raise RuntimeError("UPP connector is not implemented yet.")
