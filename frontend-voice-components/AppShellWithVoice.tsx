...
export function AppShellWithVoice({ children }: AppShellProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Voice FAB - only show for instructors */}
      {isInstructor && <VoiceFab position="bottom-right" />}
