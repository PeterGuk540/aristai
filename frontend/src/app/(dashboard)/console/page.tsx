            ...
            <div className="rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-800/25">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span key={cmd} className="rounded-full border border-neutral-200 bg-white px-3 py-1 text-sm text-neutral-600 dark:border-neutral-800 dark:bg-neutral-800 dark:text-neutral-300">
                    "{cmd}"
                  </span>
                ))}
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="rounded-xl border border-primary-200 bg-primary-50 p-4 dark:border-primary-900/30 dark:bg-primary-900/20">
                ...
                <div className="mt-3 rounded border border-primary-200 bg-white p-3 font-mono text-xs dark:border-primary-900/30 dark:bg-neutral-800">
                  email,name<br />
              ...
              {rosterResults && (
                <div className="mt-6 rounded-xl border border-neutral-200 bg-neutral-50 p-4 dark:border-neutral-800 dark:bg-neutral-800/25">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                    <div className="rounded bg-white p-3 text-center dark:bg-neutral-800">
