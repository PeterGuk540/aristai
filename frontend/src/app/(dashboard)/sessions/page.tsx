...
export default function SessionsPage() {
  ...
  return (
    <div className="space-y-8 max-w-6xl pb-4">
      {/* Page Header */}
      <div className="flex items-center justify-between rounded-xl border border-emerald-200/70 dark:border-neutral-800 bg-gradient-to-r from-emerald-50 to-sky-50 dark:from-neutral-900 dark:to-neutral-900 px-5 py-4">
        <div>
          <h1 className="text-3xl font-bold text-neutral-900 dark:text-white">{t('sessions.title')}</h1>
